...
import com.bonc.vtm.utils.Setting;
...
public class StringUtils {
    ...
    public static boolean isToday(String sdate) {
        ...
        if (time != null) {
            ...
            String timeDate = dateFormat.get().format(time);
...
//        String radomInt = String.valueOf(new Random().nextInt(999999));//[0, n)
        //        String radomInt = String.valueOf((Math.random()*9+1)*100000);
        String result = "";
        ...
        Setting setting = new Setting(context, "RandomCode");
        setting.saveString("RandomCode", result);
        return result;
    }
     ...
     * @return true 正确
     */
    public static boolean isRandomCode(Context context, String randomCode) {
        Setting setting = new Setting(context, "RandomCode");
        return randomCode.equals(setting.loadString("RandomCode"));
    }
     ...
     * @return
     */
    public static String chineseName(String string) {
        if (string == null)
            return "";
    ...
    public static int charStringLength(String str) {
