...
public class Application {
    public static CardDriver cr = new CardDriver();
    public static Instructions instructions = Instructions.getInstance();
    public static Activity mainView = null;
    public static TestThread testThread = null;
